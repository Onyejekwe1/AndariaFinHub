...
using AndariaFinHub.Infrastructure.Files;
using AndariaFinHub.Infrastructure.Identity;
using AndariaFinHub.Infrastructure.Persistence;
using AndariaFinHub.Infrastructure.Services;
using AndariaFinHub.Infrastructure.Services.Handlers;
...
namespace AndariaFinHub.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)//, IWebHostEnvironment environment)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("AndariaFinHubDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
            ...
            services.AddTransient<IFXConversionService, FXConversionService>();
